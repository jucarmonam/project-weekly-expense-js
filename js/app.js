...
class UI {
  ...
  comprobarPresupuesto(presupuestoObj) {
    ...
    if (presupuesto / 4 > restante) {
      restanteDiv.classList.remove("alert-success", "alert-warining");
    ...
    if (restante <= 0) {
      ...
      const desactivado = formulario.querySelector('button[type="submit"]').disabled = true;
      if(desactivado){
...
function agregarGasto(e) {
  ...
  if (!nombre && !cantidad) {
    ...
    ui.imprimirAlerta("Debe ser el nombre del gasto", "error");
    return;
  }
